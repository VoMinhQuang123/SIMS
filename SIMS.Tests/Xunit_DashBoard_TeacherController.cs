...
{
    public class Xunit_DashBoard_TeacherController
    {
        private readonly DashBoard_TeacherController _controller;

        public Xunit_DashBoard_TeacherController()
        {
            _controller = new DashBoard_TeacherController();
        ...
        public void Controller_CanBeInstantiated()
        {
            ...
            Assert.IsType<DashBoard_TeacherController>(_controller);
        }
